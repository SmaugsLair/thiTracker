...
public class UserDetailsView extends VerticalLayout {
    ...
    public UserDetailsView(UserRepository userRepository, CredentialsRepository credentialsRepository) {
    ...
    public void init() {
        ...
        Button savePassword = new Button("Save password", event -> {
            ...
            if (validPassword != null) {
                Credentials credentials = credRepo.findByUserId(user.getId());
